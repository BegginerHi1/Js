    ...
    fetch('http://localhost:8080/admin/users')
        ...
        .then(json => {
            ...
            json.forEach(user => {
                ...
                text += '</div>'
                text += '<div class="mb-3">'
                text += '<label for="edit-firstName" class="col-form-label"><strong>First Name</strong></label>'
                ...
                text += '</div>'
                text += '<div class="mb-3">'
                text += '<label for="edit-lastName" class="col-form-label"><strong>Last Name</strong></label>'
                ...
                text += '</div>'
                text += '<div class="mb-3">'
                text += '<label for="edit-age" class="col-form-label"><strong>Age</strong></label>'
                text += '<input style="height: 30px; width: 300px; margin: 0 auto" type="text" class="form-control" id="edit-age'+user.id+'" value="'+user.age+'">'
                text += '</div>'
                text += '<div class="mb-3">'
                text += '<label for="edit-email" class="col-form-label"><strong>Email</strong></label>'
                ...
                text += '</div>'
                text += '<div class="mb-3">'
                text += '<label for="edit-password" class="col-form-label"><strong>Password</strong></label>'
                text += '<input style="height: 30px; width: 300px; margin: 0 auto" type="password" class="form-control" id="edit-password'+user.id+'" value="'+user.password+'">'
                text += '</div>'
                text += '<div class="mb3">'
