    ...
    fetch('http://localhost:8080/admin/users')
        ...
        .then(json => {
            ...
            json.forEach(user => {
                ...
                text += '<input style="height: 30px; width: 300px; margin: 0 auto" type="text" class="form-control" id="edit-id'+user.id+'" disabled value="'+user.id+'">'
                text += '</div>'
                text += '<div class="mb-3">'
                ...
                text += '<td>'
                text += '<button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#remove'+user.id+'">delete</button>'
                text += '<div class="modal fade" id="remove'+user.id+'" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">'
                text += '<div class="modal-dialog">'
                text += '<div class="modal-content">'
                text += '<div class="modal-header">'
